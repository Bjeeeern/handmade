                       ...
                       v2 UV0, v2 UV1, v2 UV2)
{
  ...
  internal_function void
SingleTileRenderGroupToOutput(render_group* RenderGroup, game_bitmap* OutputTarget, 
                              f32 ScreenHeightInMeters, rectangle2s ClipRect)
{
                              ...
                              f32 ScreenHeightInMeters)
{
  ...
  SingleTileRenderGroupToOutput(RenderGroup, OutputTarget, ScreenHeightInMeters, ClipRect);
}
...
WORK_QUEUE_CALLBACK(DoRenderWork)
{
  ...
  SingleTileRenderGroupToOutput(RenderWork->RenderGroup, RenderWork->OutputTarget, 
